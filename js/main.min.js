...
var openModal = function openModal(triggerSelector, modalDataSelector, onModalOpened) {
...
openModal(".header__button", ".modal", function () {
  setTimeout(function () {
    return document.getElementById("input-modal-name").focus();
  }, 100);
});
...
function showMoreText() {
  var btn = document.querySelector(".about__button");
  var moreText = document.querySelector(".about__description-more");
...
document.querySelector(".about__button").addEventListener("click", showMoreText);
document.addEventListener("DOMContentLoaded", function () {
  var elements = document.querySelectorAll('[data-mask="phone"]');
  if (!elements) {
    return;
  }
  var PHONE_OPTIONS = {
...
function addAccordionListener(accordionItemElement) {
  var buttonElement = accordionItemElement.querySelector(".accordion__button");
...
addAccordionListener(document.querySelector(".footer__address.accordion__item"));

/* Источник - https://proweb63.ru/help/js/smooth-scroll-by-js */
var smoothLinks = document.querySelectorAll(".link-js");
...
try {
  var _loop = function _loop() {
    ...
    smoothLink.addEventListener("click", function (e) {
      e.preventDefault();
      var link = smoothLink.getAttribute("href");
